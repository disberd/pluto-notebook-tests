...
# ╔═╡ 6278ef43-4d60-4f72-98dd-9d4061202379
using PlotlyBase

# ╔═╡ 36760366-55b4-4f45-b39e-fa3dfac7e725
using PlutoUtils

# ╔═╡ bcd0f0a5-062c-4236-a9e9-3bb1a0ab1c4d
begin
	function is_notebook_local(filesrc::String)
...
# ╔═╡ 565784cb-c1c8-4a54-be32-c2b100b16898
@only_in_nb function test(x)
	x + 1
end

# ╔═╡ 76921aa3-722b-4e03-a980-300aa2dbfc7b
@only_out_nb function test2(x)
	x + 2
end

# ╔═╡ b12651c4-0bc9-4629-bdbc-0e5d638b1cdf
3
...
git-tree-sha1 = "18a7b465a259c38f273cfb922115ae4849c322d1"
